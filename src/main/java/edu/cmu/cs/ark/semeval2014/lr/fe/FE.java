...
public class FE {
	...
	/** If you implement this, you're saying: I know how to extract label features. */
	public static interface LabelFE {
		abstract public void features(String label, FeatureAdder fa);
	}
