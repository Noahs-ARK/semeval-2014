...
\emph{PAS} \nas{confusing because you did not use this model for PAS!}
used a weight of $0.4$ while the others were $0.3$, though the differences at this granularity were small.)
...
restriction slightly improved accuracy on the development set ($\sim 0.2\%$ absolute $F_1$-score on PAS; other formalisms unchanged).\codenote{\url{https://github.com/Noahs-ARK/semeval-2014/pull/21}}
