...
\bocomment{aside from the question of actual numbers, we need to answer the question: why did we choose the models for the formalisms, the way we did?  i was assuming the reason was due to an analysis of the 6-value (model,formalism) table, which is why i wrote the note about numbers. if the reason was something else, we need to say that.}}
}
\label{table:perf}
\end{center}
\end{table*}
