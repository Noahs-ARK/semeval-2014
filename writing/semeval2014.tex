...
\textbf{Linear Order:} 1 if $i < j$, 0 otherwise.
...
\textbf{Is Parent:} 1 if $s$ is the parent of $t$ in the syntactic
...
\textbf{Subcategorization Sequence:} For each direct child $c$ of $s$ in
...
\textbf{Subcategorization Sequence with POS tags:} For each child $c$ of
