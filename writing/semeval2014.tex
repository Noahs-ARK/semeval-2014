...
\subsubsection{\logitedge\ parser\jmf{I think we should call this \sc{LogisticEdge}}}
\label{s:logitedge}
...
This seemed to optimize faster than L-BFGS\sam{cite}, at least for earlier
...
In the FFF\jmf{what's FFF and NNN?} formalism, the training set (\S\ref{s:evaluation})
