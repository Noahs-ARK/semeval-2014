...
%\bocomment{ALTERNATE VERSION TO SAVE SPACE:
  ...
  of feature names to integer indices, used during feature extraction.
  ...
  numeric indices with a hash function, under the theory that errors
...
voice information may already have been incorporated into our feature set by the
use of the supplied Stanford dependency--style parses, which include
passivization information in arc labels such as \emph{nsubjpass} and
